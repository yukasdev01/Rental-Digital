...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-white hover:shadow-glow hover:scale-105 transition-bounce",
        destructive:
        ...
        premium: "bg-gradient-primary text-white shadow-elegant hover:shadow-glow hover:scale-105 transition-bounce border border-primary/20",
        hero: "bg-background/10 backdrop-blur-sm text-foreground border border-border/50 hover:bg-background/20 hover:border-primary/50 hover:shadow-card transition-smooth",
      },
      size: {
